# For Developers of catcode-ollama-cloud-sbx
...
```shell
docker build -t catcode-ollama-cloud-docker-sbx:latest .
docker image save catcode-ollama-cloud-docker-sbx:latest -o catcode-ollama-cloud-docker-sbx.tar
sbx template load catcode-ollama-cloud-docker-sbx.tar
sbx policy allow network "ollama.com,*.ollama.com"
sbx run shell --template catcode-ollama-cloud-docker-sbx:latest
```